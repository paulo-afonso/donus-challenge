...
class AccountServiceTest {
    ...
    @Test
    fun `Given I want to create a new account, When I send a name, CPF and invalid password, Then my account should not be created` () {
    ...
    @Test
    fun `Given I want to create a new account, When I send my name, CPF without password, Then my account should be created with a random password` () {
    ...
    @Test
    fun `Given I want to transfer to an account, When I try to send an negative value or higher than 2000, Then the transfer must fail` () {
        ...
        val invalidTransfer1 = AccountTransferFormDTO(senderAccount.cpf, receiverAccount.cpf, 3000.0, "121314")
        val invalidTransfer2 = AccountTransferFormDTO(senderAccount.cpf, receiverAccount.cpf, -100.0, "121314")

        assertThrows(InvalidTransferException::class.java) { accountService.transfer(invalidTransfer1) }
